...
STAGES = ("probe", "align", "frames", "calib", "stereo_depth", "body2d", "track", "hands", "objects", "contact", "tags", "headpose", "gaze_proxy", "body3d", "world3d", "imu_arm", "depth_mono", "scene_scan", "speech", "qc", "export", "annotate", "autolabel", "metrics")
