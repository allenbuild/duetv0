...
SPECS: dict[str, StageSpec] = {
    ...
    "contact": StageSpec(_P + "contact:contact", deps=("frames", "hands", "objects"), uses=("calib",), outputs=("contact",), config=(*_TL, "persons", "zed")),
    ...
    "annotate": StageSpec(_P + "annotate:annotate", deps=("frames",), outputs=("annotate",), config=(*_TL, "persons")),
    "autolabel": StageSpec(_P + "autolabel:autolabel", deps=("frames", "hands"), uses=("contact", "gaze_proxy", "headpose", "world3d"),
                           outputs=("autolabel",), config=(*_TL, "persons")),
    "metrics": StageSpec(_P + "metrics:metrics", deps=("frames",), uses=("hands", "body2d", "world3d", "contact", "autolabel", "speech"),
                         outputs=("metrics",), config=(*_TL, "persons")),
    "export": StageSpec(_P + "export:export", deps=("frames",),
                        uses=("calib", "stereo_depth", "body2d", "track", "hands", "objects", "contact", "tags", "headpose", "body3d", "depth_mono",
                              "scene_scan", "world3d", "gaze_proxy", "speech", "qc", "imu_arm", "autolabel", "metrics"),
